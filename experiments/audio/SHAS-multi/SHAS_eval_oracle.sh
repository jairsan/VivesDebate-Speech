...
do
    ...
    do
        ...
        python3 ../../../src/convert_audio_segmentation_to_labels.py --segment_classifier oracle: --yaml_file $path_to_custom_segmentation_yaml --timestamps_folder $TIMESTAMPS_FOLDER --output_folder $out_path
